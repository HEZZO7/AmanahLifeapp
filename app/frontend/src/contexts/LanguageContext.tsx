...
const translations: Translations = {
  ...
  pleaseEnterValidAmount: { ar: 'الرجاء إدخال مبلغ صحيح', en: 'Please enter a valid amount' },
  transactionAdded: { ar: 'تمت إضافة المعاملة', en: 'Transaction added' },
  transactionUpdated: { ar: 'تم تحديث المعاملة', en: 'Transaction updated' },
  transactionSaveFailed: { ar: 'تعذر حفظ المعاملة. حاول مرة أخرى.', en: 'Could not save the transaction. Please try again.' },
  transactionDeleteFailed: { ar: 'تعذر حذف المعاملة. حاول مرة أخرى.', en: 'Could not delete the transaction. Please try again.' },
