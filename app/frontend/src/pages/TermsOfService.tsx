...
export default function TermsOfService() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: isAr
        ? 'لأي أسئلة حول هذه الشروط، يرجى التواصل معنا عبر البريد الإلكتروني: support@amanahlife.com'
        : 'For any questions about these terms, please contact us via email: support@amanahlife.com',
    },
  ];
