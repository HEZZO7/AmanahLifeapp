...
const SEARCHABLE_ITEMS: SearchItem[] = [
  ...
  { title: 'Zakat Calculator', titleAr: 'حاسبة الزكاة', description: 'Calculate Zakat with multi-currency support', descriptionAr: 'حساب الزكاة بعملات متعددة', category: 'Finance', categoryAr: 'مالية', icon: '💰', path: '/zakat' },
  ...
  { title: 'Halal Investment', titleAr: 'الاستثمار الحلال', description: 'Islamic finance and investment tracker', descriptionAr: 'تتبع التمويل والاستثمار الإسلامي', category: 'Finance', categoryAr: 'مالية', icon: '📈', path: '/halal-investment' },
  ...
  { title: 'Islamic Calendar', titleAr: 'التقويم الهجري', description: 'Hijri calendar with important dates', descriptionAr: 'التقويم الهجري مع التواريخ المهمة', category: 'Reference', categoryAr: 'مرجع', icon: '🗓️', path: '/calendar' },
