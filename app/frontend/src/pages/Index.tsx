...
export default function HomePage() {
  ...
  const navItems = [
    ...
    { icon: '⏱️', title: t('fasting'), description: language === 'ar' ? 'تتبع الصيام' : 'Track fasting', path: '/fasting' },
    ...
    { icon: '💎', title: language === 'ar' ? 'متتبع العطاء' : 'Giving Tracker', description: language === 'ar' ? 'تتبع العطاء' : 'Track giving', path: '/giving-tracker' },
    ...
    { icon: '📊', title: language === 'ar' ? 'لوحة مالية' : 'Dashboard', description: language === 'ar' ? 'مؤشرات مالية' : 'Lifestyle KPIs', path: '/financial-dashboard' },
    { icon: '📈', title: language === 'ar' ? 'استثمار حلال' : 'Halal Invest', description: language === 'ar' ? 'التمويل الأخلاقي' : 'Ethical finance', path: '/halal-investment' },
